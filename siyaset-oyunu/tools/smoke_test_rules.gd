...
func _initialize() -> void:
	...
	check("kart bedelleri: karalama 2, vekil calma 1/2/3", cp.card_cost("karalama") == 2 		and cp.card_cost("steal_weak") == 1 and cp.card_cost("steal_medium") == 2 and cp.card_cost("steal_strong") == 3)
